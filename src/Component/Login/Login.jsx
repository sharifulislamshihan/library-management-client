...
const Login = () => {
    return (
        <div>
            <Navbar></Navbar>
            <div className="flex items-center justify-center mt-20 mx-5">
                <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-200 dark:bg-gray-900 dark:text-gray-100">
