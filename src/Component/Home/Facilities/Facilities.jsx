...
const Facilities = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-5 md:mx-7 lg:mx-10 my-10">
            <div className="flex flex-col md:flex-row gap-2 my-5">
                <FaTruck className="text-8xl my-auto text-blue-500 mx-auto "></FaTruck>
            ...
            <div className="flex flex-col md:flex-row gap-2 my-5">
                <FaShieldAlt className="text-8xl my-auto text-blue-500 mx-auto" />
            ...
            <div className="flex flex-col md:flex-row gap-2 my-5">
                <FaMoneyCheckAlt className="text-8xl my-auto text-blue-500 mx-auto" />
            ...
            <div className="flex flex-col md:flex-row gap-2 my-5">
                <FaMoneyBillTransfer className="text-8xl my-auto text-blue-500 mx-auto" />
